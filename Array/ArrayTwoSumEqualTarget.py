...
# Often, when dealing with iterators, we also get a need to keep a count of iterations. Python eases the programmers’
# task by providing a built-in function enumerate() for this task. Time Complexity: O(n)
#
