class Solution:
    def myAtoi(self, input: str) -> int:
        ...
        This function converts String to Integer which falls in range of -2^31 to 2^31-1
...
if __name__ == "__main__":
    print("Implementing C++ Atoi function in Python")

    s = "    -42"
    print("## Atoi of {} will be : {}".format(
        s, Solution().myAtoi(s)
    ))
